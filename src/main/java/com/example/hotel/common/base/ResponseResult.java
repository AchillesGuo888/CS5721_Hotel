...
public class ResponseResult<T> extends BaseObject {
    ...
    public static<T> ResponseResult<T> ofParamError() {
        return new ResponseResult<>(ResponseCode.param_error.getCode(), ResponseCode.param_error.getDesc());
    }
    ...
    public static<T> ResponseResult<T> ofSystemError() {
        return new ResponseResult<>(ResponseCode.server_err.getCode(), ResponseCode.server_err.getDesc());
    }
