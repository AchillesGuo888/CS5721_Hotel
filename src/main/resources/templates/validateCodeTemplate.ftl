...
<div style="width:578px;height:547px;margin:20px auto;">
    <div style="width:578px;height:80px;background:rgba(248,250,251,1);">
        <div style="float:right;position: relative;width: 82%;padding-top: 10px;height: 80px;">
            <div style="font-size:18px;font-family:Avenir-Heavy,Avenir;font-weight:800;color:rgba(37,39,43,1);width:80px;height:25px;line-height:25px;">UL Hotel Group co., ltd</div>
            <div style="width:72px;height:25px;font-size:18px;font-family:PingFangSC-Medium,PingFang SC;font-weight:500;color:rgba(37,39,43,1);line-height:25px;">International Booking Platform</div>
        </div>
    </div>
    <div style="margin-left:40px;margin-top:30px">
        <div class="title" style="width:96px;
            ...
            font-weight:500;
            color:rgba(103,105,110,1);
            line-height:33px;">Verification</div>
        <div class="hi" style="width:362px;
            ...
            color:rgba(103,105,110,1);
            line-height:22px;
            margin-top: 30px;">Your verification code follows：</div>
